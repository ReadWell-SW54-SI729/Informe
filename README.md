...
| ------------- |:-------------:|
| Huamán Cataño, Miguel Ángel | User Journey Mapping, Empathy Mapping, Web Applications User Flow Diagrams y Web Application Prototyping, Sección de lista de autores y libros en el frontend, Development Evidence for Sprint Review y Testing Suite Evidence for Sprint Review, Creaciónde los endpoints de clubs de lectura y comentarios.    |
