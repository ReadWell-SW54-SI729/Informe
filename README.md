...
| Párraga Gamarra, Paolo Gonzalo  |Lean Ux Canvas, User Persona, User Task Matrix, Web Applications Wireframes, Web Applications Wireflow Diagrams y Web Applications Mock-up., Diagrama de Base de datos, FRONT-END, deployment de backend front end, testing suite | 
